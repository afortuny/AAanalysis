...
#define the product division we are going to analyze
area <- 'Apparel'
...
#assign data frame to object data
data<-APP_AB_data
colnames(data)[1:5]<-c( "Article_Number","Grouping","norm_sales","ARP","fabric")
data<-as.data.frame(data)


#eliminate strange text in each level of attribute data
...
#eliminate strange text in column names
